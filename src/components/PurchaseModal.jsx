...
function PurchaseModal({ game, onClose }) {
  ...
  const miniSteps = [
    ...
    { icon: <Monitor className="w-4 h-4" />, title: "BƯỚC 2", text: "Đăng nhập Steam và Tải Game" },
    { icon: <Settings2 className="w-4 h-4" />, title: "BƯỚC 3", text: "Chuyển Offline + Tắt Cloud" },
    { icon: <CheckCircle2 className="w-4 h-4" />, title: "BƯỚC 4", text: "Vào Game Trải Nghiệm" }
  ];
  ...
  return createPortal(
    ...
    >
      ...
      {/* KHUNG MẸ CHÍNH */}
      <div className="relative w-full max-w-5xl h-[90vh] md:h-[82vh] overflow-y-auto md:overflow-hidden rounded-2xl border border-cyan-500/30 bg-[#060a12] shadow-[0_0_50px_rgba(6,182,212,0.15)] flex flex-col md:flex-row animate-in zoom-in-95 duration-300 gaming-scrollbar">

        {/* NÚT ĐÓNG MODAL DI ĐỘNG & DESKTOP */}
        <button
          onClick={onClose}
          className="absolute right-4 top-4 z-[1002] text-gray-400 hover:text-white hover:bg-red-500/80 hover:border-red-500/50 transition-all p-2 bg-black/60 border border-white/10 rounded-full backdrop-blur-md shadow-lg"
        >
        ...
        <div className="w-full md:w-[350px] p-4 sm:p-6 md:p-7 border-b md:border-b-0 md:border-r border-cyan-500/10 md:shrink-0 bg-[#080f1a] flex flex-col justify-between">
          <div className="text-center">
            ...
            <div className="my-4 flex justify-center">
              <div className="relative p-2 bg-white rounded-2xl shadow-[0_0_30px_rgba(6,182,212,0.25)] group">
                ...
                <img 
                  src={vietQRUrl} 
                  alt="Vietcombank QR" 
                  className="w-32 sm:w-36 md:w-38 h-auto rounded-xl" 
                />
              </div>
            </div>
            ...
            <div className="mb-4 p-3 rounded-xl bg-cyan-950/20 border border-cyan-500/20 text-left text-[11px] leading-relaxed">
            ...
            <div className="mb-4 p-2 rounded-xl bg-cyan-500/5 border border-cyan-500/15 animate-pulse text-center">
              <p className="text-[12px] md:text-[14px] font-bold text-cyan-300 flex items-center justify-center gap-1">
            ...
            <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="flex flex-col items-center justify-center w-full gap-1 rounded-xl bg-[#0e1624] py-2 text-[9px] min-[375px]:text-[10px] font-extrabold text-blue-400 border border-blue-500/25 hover:bg-blue-600 hover:text-white hover:border-blue-500 transition-all duration-300 active:scale-95"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="flex flex-col items-center justify-center w-full gap-1 rounded-xl bg-[#0e1624] py-2 text-[9px] min-[375px]:text-[10px] font-extrabold text-[#38bdf8] border border-[#38bdf8]/20 hover:bg-[#38bdf8] hover:text-black hover:border-[#38bdf8] transition-all duration-300 active:scale-95"
              >
              ...
              <a 
                href={links.call} 
                className="flex flex-col items-center justify-center w-full gap-1 rounded-xl bg-gradient-to-br from-cyan-400 to-blue-500 py-2 text-[9px] min-[375px]:text-[10px] font-black text-[#031018] hover:brightness-110 shadow-[0_0_12px_rgba(6,182,212,0.3)] transition-all active:scale-95"
              >
        ...
        <div className="gaming-scrollbar flex-1 bg-black/25 p-4 sm:p-6 md:p-8 md:overflow-y-auto flex flex-col gap-6">
          ...
          {/* Tiêu đề hướng dẫn */}
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-cyan-500/10 border border-cyan-500/25 text-[9px] md:text-[15px] font-bold text-cyan-400 uppercase mb-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 w-full">
            {miniSteps.map((step, i) => (
              <div 
                key={i} 
                className="group/step flex sm:flex-col items-center sm:text-center text-left gap-3 sm:gap-0 p-3 rounded-xl bg-white/[0.01] border border-cyan-500/10 hover:border-cyan-500/35 hover:bg-cyan-500/[0.02] hover:shadow-[0_0_15px_rgba(6,182,212,0.1)] transition-all duration-300"
              >
                <div className="w-8.5 h-8.5 rounded-full bg-cyan-500/10 flex items-center justify-center text-cyan-400 border border-cyan-500/20 group-hover/step:scale-105 group-hover/step:border-cyan-400 transition-all shrink-0 sm:mb-2.5">
                  {step.icon}
                </div>
